 ...
 *
 */
class GenerateThumnails_AdminController extends Omeka_Controller_AbstractActionController {

    protected function _handlePermissions() {
        if(!GenerateThumnails_Utils::hasAdminPermission()) {
    ...
    public function serverAction() {
        ...
        $form = new GenerateThumnails_Form_Server();
